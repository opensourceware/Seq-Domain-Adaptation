...
class BaseLSTM(object):
    ...
    def __init__(self):
        ...
        with tf.variable_scope("SourceLSTM", reuse=True):
            self.pretrain_lstm_fw_weights = tf.get_variable("bidirectional_rnn/fw/lstm_cell/weights", dtype="float64")
            self.pretrain_lstm_fw_biases = tf.get_variable("bidirectional_rnn/fw/lstm_cell/biases", dtype="float64")
            self.pretrain_lstm_bw_weights = tf.get_variable("bidirectional_rnn/bw/lstm_cell/weights", dtype="float64")
            self.pretrain_lstm_bw_biases = tf.get_variable("bidirectional_rnn/bw/lstm_cell/biases", dtype="float64")
